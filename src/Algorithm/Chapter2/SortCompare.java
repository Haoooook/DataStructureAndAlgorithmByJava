...
//		String[] arg = {"Insertion","Selection","10000","2"};
//		String[] arg = {"Shell","Insertion","10000","2"}; // 15.8 times faster insertion
        String[] arg = {"Shell", "Selection", "10000", "2"}; // 18.1 times faster selection
